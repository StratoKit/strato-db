...
import StatementImpl from "./Statement.mjs";
...
let connId = 1;
const _SQLiteImpl = class _SQLiteImpl extends EventEmitter {
  ...
  prepare(sql2, name) {
    ...
    return new StatementImpl(this, sql2, name);
  }
  /**
