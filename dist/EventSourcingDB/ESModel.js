...
const applyResult = require("./applyResult.js");
...
const calcUpd = (idCol, prev, obj, complete) => {
  ...
  for (const [key, value] of Object.entries(obj)) {
    ...
    if (value == null && pVal != null) {
      out[key] = null;
      changed = true;
    } else if (!lodash.isEqual(value, pVal)) {
      out[key] = value;
      changed = true;
    }
  }
...
const _ESModel = class _ESModel extends JsonModel {
  /**
  ...
  async set(obj, insertOnly, noReturn, meta) {
    if (warning.DEV && noReturn != null && typeof noReturn !== "boolean")
