 ...
 * @property {boolean} [ignoreNull=!unique]
 ...
 * @type {Object}
 * @typedef JMOptions
 * @property {DB}       db                  - a DB instance, normally passed by
 *                                          DB.
 * @property {string}   name                - the table name.
 * @property {Object}   [migrations]        - an object with migration
 *                                          functions. They are ran in
 *                                          alphabetical order.
 * @property {Object}   [migrationOptions]  - free-form data passed to the
 *                                          migration functions.
 * @property {Object}   [columns]           - the column definitions as
 *                                          {@link ColumnDef} objects. Each
 *                                          value must be a columndef or a
 *                                          function returning a columndef.
 * @property {function} [ItemClass]         - an object class to use for
 *                                          results, must be able to handle
